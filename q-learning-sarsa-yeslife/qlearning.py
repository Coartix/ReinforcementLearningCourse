...
class QLearningAgent:
    ...
    def get_value(self, state: State) -> float:
        ...
        """
        dict_action = self._qvalues[state]
        return np.max(list(dict_action.values()))
    ...
    def update(
        ...
        """
        q_value = (1 - self.learning_rate) * self.get_qvalue(state, action) + self.learning_rate * (reward + self.gamma * self.get_value(next_state))
    ...
    def get_best_action(self, state: State) -> Action:
        ...
        """
        dict_action = self._qvalues[state]
        best_action = np.argmax(list(dict_action.values()))
        return best_action
